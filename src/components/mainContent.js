    ...
    return (
        <div className="main-content">
            <div className="info-lidia">
                ...
                <div>
                    <p className="name">
                        Olá, eu sou <span className="purple">Lídia Torres!</span>
                    </p>
            ...
            <div className="about-me" id="about-me">
                ...
                <p>
                    Durante minha formação técnica, descobri uma grande paixão pela programação. Desde então, venho me dedicando ao <span className="purple">desenvolvimento de projetos individuais</span> para aprimorar minhas habilidades e evoluir profissionalmente na área.
                </p>
            </div>
        </div>
    );
